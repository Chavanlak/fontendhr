...
{{-- <body> --}}
  ...
  <div>
    ...
    <div class=" py-3 px-1 d-grid gap-2 d-md-flex justify-content-md-end ">
      <a class="btn btn-primary  md-8 font-family-monospace" href="/setkpi/create">เพิ่มพนักงาน</a>
    </div>
{{-- </div>
    ...
    {{-- <table class="table table-bordered border-whitetable table-bordered text-center "style="width: 100%"> --}}
      ...
      <tr class="head">
        ...
        {{-- <tbody> --}}
            ...
            <td>4 ข้อ</td>
            <td><a class="px-1 btn btn-success"  href="{{ route('setkpi.edit',['setkpi' => $setkpi->idset]) }}">แก้ไข</a></td>
