...
<body> --}}
    ...
    <div class=" py-3 px-1 d-grid gap-2 d-md-flex justify-content-md-end ">
        <a class="btn btn-primary  md-8 font-family-monospace" href="{{ route('criteriakpi.create') }}">เพิ่มหัวข้อการประเมิน</a>
      </div>
        ...
        <div class=" table-responsive text-center"style="width: 100%">
            ...
            @foreach ($criteriakpis as $criteriakpi)
                ...
                <tr>
                    ...
                    <td>
                        <a class="px-1 btn btn-success" href="{{ route('criteriakpi.edit',['criteriakpi' => $criteriakpi->crID]) }}">เเก้ไข</a>
                    </td>
                    <td>
