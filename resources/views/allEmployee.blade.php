...
@section('content')
    ...
    <div class=" py-3 px-1 d-grid gap-2 d-md-flex justify-content-md-end ">
        <a class="btn btn-primary  md-8 font-family-monospace" href="{{ route('addemployee') }}">เพิ่มพนักงาน</a>
      </div>
    <div>
        ...
        <table style="width: 100%"> 
            ...
            @foreach ($employees as $employee)
                ...
                <tr>
                    ...
                    <td>
                        <a class="px-1 btn btn-success" href="{{ route('employee.edit',['employee' => $employee->empID]) }}">เเก้ไข</a>
                    </td>
                    <td>
                        <form method="POST" action="{{ route('destroyEmployee',['employee'=> $employee->empID]) }}">
                            @csrf
                            {{-- @method('delete') --}}
