...
public function index()
    {
        ...
        $employees = DB::table('employee')
            ...
            ->get();
        return view('allemployee', ['employees' => $employees]);
    ...
    public function create()
    {
        ...
        return view('addEmployee', ['employees' => $employees, 'positions' => $positions, 'saleteams' => $saleteams]); // ส่งตัวแปร $employees ไปยัง View
    }
    ...
    public function edit($id)
    {
        ...
        return view('editEmployeeHRPages', ['employee' => $employee, 'positions' => $positions, 'saleteams' => $saleteams]);
    }
    ...
    public function update(Employee $employee, Request $request)
    {
        ...
        return redirect(route('allemployee'))->with('success', 'Employee update successfully');

    }
    public function destroy(Employee $employee)
    {
        $employee->delete();
        return redirect(route('allemployee'))->with('success', 'Employee delete successfully');
    }
